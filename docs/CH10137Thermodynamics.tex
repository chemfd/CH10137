...
The equilbrium constant for a reaction is defined as the \emph{activity} of the products raised to their stoichiometric quantity divided by the \emph{activity} of the prodcuts raised to their stoichiometric quantity (equation \eqref{eq:equilibrium}).
