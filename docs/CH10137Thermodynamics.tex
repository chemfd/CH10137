...
\midrule()
\endhead
CH\textsubscript{3}CH\textsubscript{2}OH (aq) & 111.46 \\
CH\textsubscript{3}COOH (aq) & 124.3 \\
CH\textsubscript{3}COOCH\textsubscript{2}CH\textsubscript{3} (aq) & 170.1 \\
H\textsubscript{2}O (l) & 33.58 \\
\bottomrule()
\end{longtable}
...
\begin{longtable}[]{@{}cc@{}}
\toprule()
& C\textsubscript{p} / J K\textsuperscript{−1} mol\textsuperscript{−1} \\
\midrule()
\endhead
C\textsubscript{2}H\textsubscript{6} & 52.6 \\
O\textsubscript{2} & 29.4 \\
CO\textsubscript{2} & 37.1 \\
H\textsubscript{2}O & 75.3 \\
\bottomrule()
\end{longtable}
...
\(\Delta_{vap} S^\ominus\) / J K\textsuperscript{−1} mol\textsuperscript{−1}
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\(\Delta_{vap} H^\ominus\) / kJ mol\textsuperscript{−1}
\end{minipage} & \begin{minipage}[b]{\linewidth}\centering
\(T_b\) / K
\end{minipage} \\
\midrule()
...
\begin{longtable}[]{@{}cc@{}}
\toprule()
& Sm° / J K\textsuperscript{−1} mol\textsuperscript{−1} \\
\midrule()
\endhead
NH\textsubscript{4}Cl(s) & 94.85 \\
NH3(g) & 192.77 \\
HCl(g) & 186.90 \\
\bottomrule()
\end{longtable}
...
\midrule()
\endhead
+ endothermic & + & + at low T − at high T & spontaneous at high temperature \\
+ endothermic & − & + & needs work to occur \\
− exothermic & + & − & always spontaneous \\
− exothermic & − & − at low T + at high T & spontaneous at low temperature \\
\bottomrule()
\end{longtable}
...
\item
  \(\Delta S\) = 33 J K\textsuperscript{-1} mol\textsuperscript{-1}, \(\Delta H\) = −323.2 kJ mol\textsuperscript{-1} \href{https://youtu.be/scaI8nTFaAo}{worked solution} \href{http://workitoutwithapencil.xyz/wp-content/uploads/2021/12/Week-4-part-2-Q3.pdf}{Handwritten notes}
\item
...
\toprule()
& Ag\textsubscript{2}CO\textsubscript{3} & Ag\textsubscript{2}O & CO\textsubscript{2} \\
\midrule()
\endhead
Δ\textsubscript{f}H\textsuperscript{⦵} / kJ mol\textsuperscript{−1} & −501.4 & −29.07 & −393.5 \\
S\textsubscript{m}\textsuperscript{⦵} / J K\textsuperscript{−1} mol\textsuperscript{−1} & 167.3 & 121.7 & 213.7 \\
C\textsubscript{p} / J K\textsuperscript{−1} mol\textsuperscript{−1} & 109.6 & 68.6 & 37.1 \\
\bottomrule()
\end{longtable}
...
\item
  ...
  \end{enumerate}
\item
  K = 0.011 \href{https://youtu.be/7gEkEwPtqws}{Video workthrough of solution} \href{http://workitoutwithapencil.xyz/wp-content/uploads/2022/11/Week-4-Part-2-Q3.pdf}{Notes from video}
\end{enumerate}
...
\begin{longtable}[]{@{}cccc@{}}
\toprule()
& Δ\textsubscript{f}H\textsuperscript{⦵} & S\textsuperscript{⦵}\textsubscript{m} J K\textsuperscript{−1} mol\textsuperscript{−1} & C\textsubscript{p} / J K\textsuperscript{−1} mol\textsuperscript{−1} \\
\midrule()
\endhead
MgO (s) & -601.7 & 26.9 & 37.2 \\
CO (g) & -110.5 & 197.7 & 29.1 \\
Mg (s) & 0 & 32.7 & 24.9 \\
CO\textsubscript{2} (g) & -393.5 & 213.7 & 37.1 \\
\bottomrule()
\end{longtable}
...
NO\textsubscript{2} (g) & +33.18 & 240.06 & 37.20 \\
N\textsubscript{2}O\textsubscript{5} (g) & +11.3 & 355.7 & 84.5 \\
O\textsubscript{2} & - & 205.138 & 29.355 \\
\bottomrule()
\end{longtable}
