...
\item
  Use the following data to calculate the reaction entropy at 298 K for the thermal decomposition of 2.651 g of ammonium chloride, NH4Cl
\end{enumerate}

NH\textsubscript{4}Cl(s) → NH\textsubscript{3}(g) + HCl(g)

\textbar{} Sm° / J K\textsuperscript{−1} mol\textsuperscript{−1} \textbar{}\\
NH\textsubscript{4}Cl(s) \textbar{} 94.85 \textbar{}\\
NH3(g) \textbar{} 192.77 \textbar{}\\
HCl(g) \textbar{} 186.90 \textbar{}
