...
\toprule
& \(\Delta_{vap} S^\ominus\) / J K\textsuperscript{−1} mol\textsuperscript{−1} & \(\Delta_{vap} H^\ominus\) / kJ mol\textsuperscript{−1} & \(T_b\) / K \\
\midrule
\endfirsthead
\toprule
& \(\Delta_{vap} S^\ominus\) / J K\textsuperscript{−1} mol\textsuperscript{−1} & \(\Delta_{vap} H^\ominus\) / kJ mol\textsuperscript{−1} & \(T_b\) / K \\
...
\midrule
\endhead
ΔH\textsuperscript{⦵} / kJ mol\textsuperscript{−1} & −501.4 & −29.07 & −393.5 \\
